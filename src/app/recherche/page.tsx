...
//             <Link href="/">
//               <span className="font-bold text-xl">Niger Info</span>
//             </Link>
//           </div>
//           <div className="hidden md:flex items-center gap-8 text-sm">
//             <Link href="/articles" className="hover:text-gray-500">
//               Articles
//             </Link>
//             <Link href="/rubriques" className="hover:text-gray-500">
//               Rubriques
//             </Link>
//             <Link href="/contact" className="hover:text-gray-500">
//               Contact
//             </Link>
//             <Link href="/a-propos" className="hover:text-gray-500">
//               À propos
//             </Link>
//           </div>
...
//             <div>
//               <h3 className="font-bold text-lg mb-4">Niger Info</h3>
