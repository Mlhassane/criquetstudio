      ...
      <section className="container mx-auto px-4 py-8">
        ...
        <div className="border-y border-gray-200 py-4 mb-8">
          <div className="flex overflow-x-auto space-x-4 scrollbar-hide py-1">
            <Link href="/articles" className="whitespace-nowrap px-4 py-2 rounded-full bg-red-600 text-white text-sm font-medium">
              Tous les articles
            </Link>
            ...
            >
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="mt-auto flex items-center">
                  ...
                  <span className="text-xs text-gray-500">Par {article.author?.name || 'Rédaction'}</span>
                </div>
              </div>
            </Link>
          ))}
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-xs text-gray-500 mb-1">
                    {article.categories && article.categories[0] ? 
                      <span className="text-red-600 mr-2">{article.categories[0].title}</span> : null
                    }
                    {new Date(article.publishedAt).toLocaleDateString('fr-FR')}
                  </div>
          ...
          <div className="max-w-xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                ...
                required
              />
              <button type="submit" className="bg-red-600 text-white font-medium px-6 py-3 rounded-lg hover:bg-red-700 transition">
                S'abonner
              </button>
            </form>
            <p className="text-xs text-gray-500 mt-3">En vous inscrivant, vous acceptez notre politique de confidentialité</p>
          </div>
        </div>
      </section>
    </>
